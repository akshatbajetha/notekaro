    ...
    <>
      ...
      {/* {sidebarOpen && (
        <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
          <SheetContent
            side="bottom"
            className="h-auto max-h-[80vh] w-full rounded-t-[20px] px-4 py-4 overflow-auto overflow-x-hiddenustom-scrollbar Island"
          >
      ...
      <Sheet open={colorPickerOpen} onOpenChange={setColorPickerOpen}>
        <SheetContent
          side="bottom"
          className="h-auto max-h-[80vh] w-full rounded-t-[20px] px-4 py-4 overflow-auto overflow-x-hidden custom-scrollbar Island"
        >
          <SheetHeader className="mb-5">
