  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#F5F5F5] dark:bg-[#1E1E1E] dark:text-gray-200">
      ...
      <main className="flex-1">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                ...
                <Button
                  variant="outline"
                  className="flex items-center gap-2 border-gray-300 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800"
                >
                  <span className="size-2 rounded-full bg-black dark:bg-white"></span>
                  See How It Works
                </Button>
              </div>
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  <div className="flex items-center justify-center size-8 rounded-full bg-blue-500 text-white text-xs font-medium">
                    JD
                  </div>
                  <div className="flex items-center justify-center size-8 rounded-full bg-green-500 text-white text-xs font-medium">
                    AK
                  </div>
                  <div className="flex items-center justify-center size-8 rounded-full bg-purple-500 text-white text-xs font-medium">
                    MR
                  </div>
                  <div className="flex items-center justify-center size-8 rounded-full bg-yellow-500 text-white text-xs font-medium">
                    SR
                  </div>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Joined by 20,000+ productive professionals
                </p>
              </div>
            </div>
        ...
        <section id="pricing" className="py-16 bg-[#F5F5F5] dark:bg-[#1E1E1E]">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl dark:text-white">
            ...
            <Tabs defaultValue="monthly" className="w-full max-w-3xl mx-auto">
              ...
              <TabsContent value="monthly">
                <div className="grid gap-8 md:grid-cols-3">
                  ...
                  <Card className="border-2 border-blue-600 dark:border-blue-500 bg-white dark:bg-gray-900 relative">
                  ...
                  <Card className="border-2 border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                    <CardContent className="p-6">
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-sm text-green-600 dark:text-green-400 font-medium">
                          Save $47.88 compared to monthly
                        </p>
                      </div>
                      <ul className="space-y-2 mb-6">
                        <li className="flex items-center text-gray-700 dark:text-gray-300">
        ...
        <section className="py-16 bg-blue-800 dark:bg-gray-900 text-white">
