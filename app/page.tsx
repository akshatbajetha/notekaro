      ...
      <section className="py-20 h-screen flex justify-center items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-6xl font-bold mb-6">NoteKaro</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-4">Clean Notes</h3>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-4">Visual Canvas</h3>
              <p className="text-foreground/70">
